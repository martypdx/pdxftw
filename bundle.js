...
},{"./app":2,"./components":3,"ractive":8,"ractive-events-tap":6}],2:[function(require,module,exports){
var Ractive = require('ractive');

var __options__ = {
	template: {v:3,t:[{p:[1,1,0],t:7,e:"h1",f:["Ractive Starter Project"]}," ",{p:[2,1,33],t:7,e:"p",f:["Hello World"]}," ",{p:[3,1,52],t:7,e:"widget"}]},
	css:"h1{color:#4682b4}",
},
component={},
__prop__,
__export__;if ( typeof component.exports === "object" ) {
...
},{"ractive":8}],3:[function(require,module,exports){
var Ractive = require('ractive');

Ractive.components['app'] = require('./app');
Ractive.components['widget'] = require('./widget');

},{"./app":2,"./widget":5,"ractive":8}],4:[function(require,module,exports){
'use strict';
...
__export__ = Ractive.extend( __options__ );
module.exports = __export__;
},{"./upper-caser":4,"ractive":8,"ractive-transitions-fade":7}],6:[function(require,module,exports){
